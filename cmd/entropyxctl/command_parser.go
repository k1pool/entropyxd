...
func parseCommand(args []string, commandDescs []*commandDescription) (*protowire.EntropyxdMessage, error) {
	...
	return generateEntropyxdMessage(commandValue, commandDesc)
}

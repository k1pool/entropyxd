...
func createUnsignedTransactionSerialized(
	...
	payments []*libentropyxwallet.Payment,
	selectedUTXOs []*libentropyxwallet.UTXO) ([]byte, error) {

	tx, err := libentropyxwallet.CreateUnsignedTransaction(extendedPublicKeys, minimumSignatures, payments, selectedUTXOs)
	if err != nil {
		return nil, err
	}

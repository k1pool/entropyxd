...
var file_entropyxwalletd_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_entropyxwalletd_proto_goTypes = []interface{}{
	...
	(*CreateUnsignedTransactionsRequest)(nil),  // 3: entropyxwalletd.CreateUnsignedTransactionsRequest
	(*CreateUnsignedTransactionsResponse)(nil), // 4: entropyxwalletd.CreateUnsignedTransactionsResponse
	(*ShowAddressesRequest)(nil),               // 5: entropyxwalletd.ShowAddressesRequest
	(*ShowAddressesResponse)(nil),              // 6: entropyxwalletd.ShowAddressesResponse
	(*NewAddressRequest)(nil),                  // 7: entropyxwalletd.NewAddressRequest
	(*NewAddressResponse)(nil),                 // 8: entropyxwalletd.NewAddressResponse
	(*BroadcastRequest)(nil),                   // 9: entropyxwalletd.BroadcastRequest
	(*BroadcastResponse)(nil),                  // 10: entropyxwalletd.BroadcastResponse
	(*ShutdownRequest)(nil),                    // 11: entropyxwalletd.ShutdownRequest
	(*ShutdownResponse)(nil),                   // 12: entropyxwalletd.ShutdownResponse
	(*Outpoint)(nil),                           // 13: entropyxwalletd.Outpoint
	(*UtxosByAddressesEntry)(nil),              // 14: entropyxwalletd.UtxosByAddressesEntry
	(*ScriptPublicKey)(nil),                    // 15: entropyxwalletd.ScriptPublicKey
	(*UtxoEntry)(nil),                          // 16: entropyxwalletd.UtxoEntry
	(*GetExternalSpendableUTXOsRequest)(nil),   // 17: entropyxwalletd.GetExternalSpendableUTXOsRequest
	(*GetExternalSpendableUTXOsResponse)(nil),  // 18: entropyxwalletd.GetExternalSpendableUTXOsResponse
	(*SendRequest)(nil),                        // 19: entropyxwalletd.SendRequest
	(*SendResponse)(nil),                       // 20: entropyxwalletd.SendResponse
	(*SignRequest)(nil),                        // 21: entropyxwalletd.SignRequest
	(*SignResponse)(nil),                       // 22: entropyxwalletd.SignResponse
}
var file_entropyxwalletd_proto_depIdxs = []int32{
	...
	13, // 1: entropyxwalletd.UtxosByAddressesEntry.outpoint:type_name -> entropyxwalletd.Outpoint
	16, // 2: entropyxwalletd.UtxosByAddressesEntry.utxoEntry:type_name -> entropyxwalletd.UtxoEntry
	15, // 3: entropyxwalletd.UtxoEntry.scriptPublicKey:type_name -> entropyxwalletd.ScriptPublicKey
	14, // 4: entropyxwalletd.GetExternalSpendableUTXOsResponse.Entries:type_name -> entropyxwalletd.UtxosByAddressesEntry
	0,  // 5: entropyxwalletd.entropyxwalletd.GetBalance:input_type -> entropyxwalletd.GetBalanceRequest
	17, // 6: entropyxwalletd.entropyxwalletd.GetExternalSpendableUTXOs:input_type -> entropyxwalletd.GetExternalSpendableUTXOsRequest
	3,  // 7: entropyxwalletd.entropyxwalletd.CreateUnsignedTransactions:input_type -> entropyxwalletd.CreateUnsignedTransactionsRequest
	5,  // 8: entropyxwalletd.entropyxwalletd.ShowAddresses:input_type -> entropyxwalletd.ShowAddressesRequest
	7,  // 9: entropyxwalletd.entropyxwalletd.NewAddress:input_type -> entropyxwalletd.NewAddressRequest
	11, // 10: entropyxwalletd.entropyxwalletd.Shutdown:input_type -> entropyxwalletd.ShutdownRequest
	9,  // 11: entropyxwalletd.entropyxwalletd.Broadcast:input_type -> entropyxwalletd.BroadcastRequest
	19, // 12: entropyxwalletd.entropyxwalletd.Send:input_type -> entropyxwalletd.SendRequest
	21, // 13: entropyxwalletd.entropyxwalletd.Sign:input_type -> entropyxwalletd.SignRequest
	1,  // 14: entropyxwalletd.entropyxwalletd.GetBalance:output_type -> entropyxwalletd.GetBalanceResponse
	18, // 15: entropyxwalletd.entropyxwalletd.GetExternalSpendableUTXOs:output_type -> entropyxwalletd.GetExternalSpendableUTXOsResponse
	4,  // 16: entropyxwalletd.entropyxwalletd.CreateUnsignedTransactions:output_type -> entropyxwalletd.CreateUnsignedTransactionsResponse
	6,  // 17: entropyxwalletd.entropyxwalletd.ShowAddresses:output_type -> entropyxwalletd.ShowAddressesResponse
	8,  // 18: entropyxwalletd.entropyxwalletd.NewAddress:output_type -> entropyxwalletd.NewAddressResponse
	12, // 19: entropyxwalletd.entropyxwalletd.Shutdown:output_type -> entropyxwalletd.ShutdownResponse
	10, // 20: entropyxwalletd.entropyxwalletd.Broadcast:output_type -> entropyxwalletd.BroadcastResponse
	20, // 21: entropyxwalletd.entropyxwalletd.Send:output_type -> entropyxwalletd.SendResponse
	22, // 22: entropyxwalletd.entropyxwalletd.Sign:output_type -> entropyxwalletd.SignResponse

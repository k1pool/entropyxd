...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := entropyxd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = entropyxd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = entropyxd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(

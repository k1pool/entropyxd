...
// MsgIBDChainBlockLocator implements the Message interface and represents a entropyx
...
// NewMsgIBDChainBlockLocator returns a new entropyx locator message that conforms to

...
// MsgDoneHeaders implements the Message interface and represents a entropyx
...
// NewMsgDoneHeaders returns a new entropyx DoneIBDBlocks message that conforms to the
// Message interface.

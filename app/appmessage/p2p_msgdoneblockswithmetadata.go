...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a entropyx
...
// NewMsgDoneBlocksWithTrustedData returns a new entropyx DoneBlocksWithTrustedData message that conforms to the
// Message interface.

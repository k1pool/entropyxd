...
// MsgRequestNextHeaders implements the Message interface and represents a entropyx
...
// NewMsgRequestNextHeaders returns a new entropyx RequestNextHeaders message that conforms to the
// Message interface.

...
var DefaultUserAgent = fmt.Sprintf("/entropyxd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a entropyx version
...
// NewMsgVersion returns a new entropyx version message that conforms to the

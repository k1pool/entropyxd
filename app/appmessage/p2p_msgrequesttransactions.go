...
// MsgRequestTransactions implements the Message interface and represents a entropyx
...
// NewMsgRequestTransactions returns a new entropyx RequestTransactions message that conforms to

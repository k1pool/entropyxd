...
// MsgRequestHeaders implements the Message interface and represents a entropyx
...
// NewMsgRequstHeaders returns a new entropyx RequestHeaders message that conforms to the

...
// entropyx Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a entropyx
// Addresses message.
...
// NewMsgAddresses returns a new entropyx Addresses message that conforms to the

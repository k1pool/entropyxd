...
// MsgRequestAnticone implements the Message interface and represents a entropyx
...
// NewMsgRequestAnticone returns a new entropyx RequestPastDiff message that conforms to the

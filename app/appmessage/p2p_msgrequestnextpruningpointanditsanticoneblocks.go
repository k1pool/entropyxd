...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a entropyx
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new entropyx RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.

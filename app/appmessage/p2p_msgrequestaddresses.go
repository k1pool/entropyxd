...
// MsgRequestAddresses implements the Message interface and represents a entropyx
...
// NewMsgRequestAddresses returns a new entropyx RequestAddresses message that conforms to the

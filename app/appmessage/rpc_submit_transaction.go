...
// RPCTransaction is a entropyxd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a entropyxd transaction input representation
...
// RPCScriptPublicKey is a entropyxd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a entropyxd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a entropyxd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a entropyxd utxo entry representation meant to be used
// over RPC

...
// MsgInvTransaction implements the Message interface and represents a entropyx
...
// NewMsgInvTransaction returns a new entropyx TxInv message that conforms to

...
import (
	...
	"github.com/k1pool/entropyxd/app/rpc"
	...
	"github.com/k1pool/entropyxd/infrastructure/network/netadapter/id"
	"github.com/k1pool/entropyxd/util/panics"
)

// ComponentManager is a wrapper for all the entropyxd services
...
// Start launches all the entropyxd services.
...
// Stop gracefully shuts down all the entropyxd services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("Entropyxd is already in the process of shutting down")
		return
	}

	log.Warnf("Entropyxd shutting down")

...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/k1pool/entropyxd/database)

Package database provides a database for entropyxd.
...
DataAccessor
------------
This defines the common interface by which data gets accessed in a generic entropyxd
...
Transaction
-----------
This defines the interface of a generic entropyxd database transaction.

...
// installService attempts to install the entropyxd service. Typically this should
...
// removeService attempts to uninstall the entropyxd service. Typically this should
...
// startService attempts to Start the entropyxd service.

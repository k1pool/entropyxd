...
func (x *EntropyxdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "EntropyxdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *EntropyxdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {

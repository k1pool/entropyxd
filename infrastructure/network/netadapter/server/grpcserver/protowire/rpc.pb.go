...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether entropyxd thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when entropyxd is not synced.
	// That is because when entropyxd isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this entropyxd initiated the connection
	...
	// The timestamp of when this peer connected to this entropyxd

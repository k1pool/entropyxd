...
func (x *EntropyxdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "EntropyxdMessage_Addresses is nil")
	}
...
func (x *EntropyxdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {

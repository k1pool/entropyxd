...
type P2P_MessageStreamClient interface {
	Send(*EntropyxdMessage) error
	Recv() (*EntropyxdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *EntropyxdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*EntropyxdMessage, error) {
	m := new(EntropyxdMessage)
...
func (x *p2PMessageStreamServer) Send(m *EntropyxdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*EntropyxdMessage, error) {
	m := new(EntropyxdMessage)
...
func (x *rPCMessageStreamClient) Send(m *EntropyxdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*EntropyxdMessage, error) {
	m := new(EntropyxdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *EntropyxdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*EntropyxdMessage, error) {
	m := new(EntropyxdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}

...
import (
	...
	"github.com/k1pool/entropyxd/util/mstime"
	"github.com/pkg/errors"
)

func (x *EntropyxdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "EntropyxdMessage_Version is nil")
	}
...
func (x *EntropyxdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {

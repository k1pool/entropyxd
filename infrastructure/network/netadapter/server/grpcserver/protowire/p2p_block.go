...
func (x *EntropyxdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "EntropyxdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *EntropyxdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {

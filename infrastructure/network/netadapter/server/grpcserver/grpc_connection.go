...
type grpcStream interface {
	Send(*protowire.EntropyxdMessage) error
	Recv() (*protowire.EntropyxdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.EntropyxdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.EntropyxdMessage) error {

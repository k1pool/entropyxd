/*
Package addressmanager implements concurrency safe Entropyx address manager.

# Address Manager Overview

In order maintain the peer-to-peer Entropyx network, there needs to be a source
of addresses to connect to as nodes come and go. The Entropyx protocol provides

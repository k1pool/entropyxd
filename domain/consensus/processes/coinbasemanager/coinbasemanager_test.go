...
func TestCalcDeflationaryPeriodBlockSubsidy(t *testing.T) {
	...
	const deflationaryPhaseBaseSubsidy = 440 * constants.SompiPerEntropyx
...
func TestBuildSubsidyTable(t *testing.T) {
	...
	// if deflationaryPhaseBaseSubsidy != 440*constants.SompiPerEntropyx {
	...
	// fmt.Println(sumSup / constants.SompiPerEntropyx)
	// fmt.Println(sumSup * 2629800 / constants.SompiPerEntropyx)
}

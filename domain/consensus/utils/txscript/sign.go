...
// SignatureScript creates an input signature script for tx to spend ENX sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend ENX sent

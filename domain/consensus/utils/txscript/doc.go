/*
Package txscript implements the entropyx transaction script language.

This package provides data structures and functions to parse and execute
entropyx transaction scripts.

# Script Overview

Entropyx transaction scripts are written in a stack-base, FORTH-like language.

The entropyx script language consists of a number of opcodes which fall into
...
Typical entropyx scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend entropyx.

...
import (
	...
	"github.com/k1pool/entropyxd/domain/consensus/utils/serialization"

	"github.com/k1pool/entropyxd/domain/consensus/model/externalapi"
	"github.com/k1pool/entropyxd/domain/consensus/utils/hashes"
	"github.com/k1pool/entropyxd/domain/consensus/utils/transactionhelper"
	"github.com/k1pool/entropyxd/util/binaryserializer"
...
// writeTransactionInput encodes ti to the entropyx protocol encoding for a transaction
// input to w.

...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerEntropyx
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SompiPerEntropyx
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SompiPerEntropyx

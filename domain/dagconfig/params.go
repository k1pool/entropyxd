...
// Params defines a Entropyx network by its parameters. These parameters may be
// used by Entropyx applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/entropyx-launch-plan-9a63f4d754a6
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/entropyxnet/research/issues/3
...
// MainnetParams defines the network parameters for the main Entropyx network.
var MainnetParams = Params{
	...
	DNSSeeds: []string{
		...
		"mainnet-dnsseed-1.entropyxnet.org",
		// This DNS seeder is run by Denis Mashkevich
		"mainnet-dnsseed-2.entropyxnet.org",
		// This DNS seeder is run by Constantine Bytensky
		"dnsseed.cbytensky.org",
		// This DNS seeder is run by Georges Künzli
		"seeder1.entropyxd.net",
		// This DNS seeder is run by Georges Künzli
		"seeder2.entropyxd.net",
		// This DNS seeder is run by Georges Künzli
		"seeder3.entropyxd.net",
		// This DNS seeder is run by Georges Künzli
		"seeder4.entropyxd.net",
		// This DNS seeder is run by Tim
		"entropyxdns.entropyxcalc.net",
		// This DNS seeder is run by supertypo
		"n-mainnet.entropyx.ws",
	},
	...
	Prefix: util.Bech32PrefixEntropyx,
...
// TestnetParams defines the network parameters for the test Entropyx network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "entropyx-testnet-10",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixEntropyxTest,
...
// SimnetParams defines the network parameters for the simulation test Entropyx
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixEntropyxSim,
...
// DevnetParams defines the network parameters for the development Entropyx network.
var DevnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "entropyx-devnet",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixEntropyxDev,
...
// ErrDuplicateNet describes an error where the parameters for a Entropyx
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Entropyx network")

var registeredNets = make(map[appmessage.EntropyxNet]struct{})

// Register registers the network parameters for a Entropyx network. This may

...
import (
	...
	"github.com/k1pool/entropyxd/util/bech32"
)
...
const (
	...
	Bech32PrefixEntropyx

	// Prefix for the dev network.
	Bech32PrefixEntropyxDev

	// Prefix for the test network.
	Bech32PrefixEntropyxTest

	// Prefix for the simulation network.
	Bech32PrefixEntropyxSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"entropyx":     Bech32PrefixEntropyx,
	"entropyxdev":  Bech32PrefixEntropyxDev,
	"entropyxtest": Bech32PrefixEntropyxTest,
	"entropyxsim":  Bech32PrefixEntropyxSim,
}
...
// and a payload which encodes the entropyx network and address type. It is used
...
// with the passed entropyx network.

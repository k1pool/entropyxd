...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "entropyx:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "entropyx:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixEntropyx,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixEntropyx)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixEntropyx,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "entropyx:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "entropyx:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixEntropyx,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixEntropyx,
			expectedPrefix: util.Bech32PrefixEntropyx,
		},
		{
			name:    "testnet p2pk",
			addr:    "entropyxtest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "entropyxtest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixEntropyxTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixEntropyxTest)
			},
			passedPrefix:   util.Bech32PrefixEntropyxTest,
			expectedPrefix: util.Bech32PrefixEntropyxTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "entropyx:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "entropyx:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixEntropyx)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixEntropyx,
		},
		...
		},
		{
			...
			addr:           "entropyx:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixEntropyx,
			expectedPrefix: util.Bech32PrefixEntropyx,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "entropyx:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "entropyx:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixEntropyx)
			},
			passedPrefix:   util.Bech32PrefixEntropyx,
			expectedPrefix: util.Bech32PrefixEntropyx,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "entropyx:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "entropyx:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixEntropyx,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixEntropyx)
			},
			passedPrefix:   util.Bech32PrefixEntropyx,
			expectedPrefix: util.Bech32PrefixEntropyx,
		},
		{
			name:    "testnet p2sh",
			addr:    "entropyxtest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "entropyxtest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixEntropyxTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixEntropyxTest)
			},
			passedPrefix:   util.Bech32PrefixEntropyxTest,
			expectedPrefix: util.Bech32PrefixEntropyxTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"entropyxsim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixEntropyxSim,
			"unknown address type",
		},
		{
			"entropyxsim:raskzcg58mth0an",
			util.Bech32PrefixEntropyxSim,
			"unknown address type",
		},
		{
			"entropyxtest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixEntropyx,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"entropyx", util.Bech32PrefixEntropyx, false},
		{"entropyxtest", util.Bech32PrefixEntropyxTest, false},
		{"entropyxsim", util.Bech32PrefixEntropyxSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixEntropyx, "entropyx"},
		{util.Bech32PrefixEntropyxTest, "entropyxtest"},
		{util.Bech32PrefixEntropyxSim, "entropyxsim"},
		{util.Bech32PrefixUnknown, ""},
	}
